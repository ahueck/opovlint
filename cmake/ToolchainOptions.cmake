...
if(CMAKE_COMPILER_IS_CLANGXX AND SANITIZE)
  ...
  if(SANITIZE_UPPER STREQUAL "ASAN")
    set(CXX_ONLY_FLAGS "${CXX_ONLY_FLAGS} -fsanitize=address -fno-optimize-sibling-calls -fno-omit-frame-pointer -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/scripts/blacklist-asan.txt")
  elseif(SANITIZE_UPPER STREQUAL "MSAN")
    set(CXX_ONLY_FLAGS "${CXX_ONLY_FLAGS} -fsanitize=memory -fno-optimize-sibling-calls -fno-omit-frame-pointer -fsanitize-memory-track-origins=2 -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/scripts/blacklist-msan.txt")
...
message(STATUS "CCache is active: "       ${CCACHE_EXISTS}
