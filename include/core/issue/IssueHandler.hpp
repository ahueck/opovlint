...
namespace opov {
template<typename T>
void IssueHandler::addIssue(const clang::SourceManager& sm, const clang::ASTContext& ac, T node, const std::string& module, const std::string& module_descr, std::string message) {
	/* FIXME remove as it is a hardcoded filter...
